...
2. 접속하면 로그인 화면이 뜹니다 — 시드된 **데모** 프로필 선택 후 PIN `1234` 입력 (또는 "새 프로필 만들기"로 직접 생성)
3. 홈에서 **CES 2027 Press Conference** 프로젝트 클릭
4. **타임테이블 · 구조** 탭 — 9개 프로그램과 13개 자원 확인, 각 항목 수정 가능
5. **사전 위험 진단** 탭 — "위험 진단 실행"으로 결정론적 진단 실행 (시드된 6개 위험 + 자동 진단 결과 병합)
